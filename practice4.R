...
#FreeThrows(Matrix)
Player_FT <- rbind(KobeBryant_FT, JoeJohnson_FT, LeBronJames_FT, CarmeloAnthony_FT, DwightHoward_FT, ChrisBosh_FT, ChrisPaul_FT,
                   KevinDurant_FT, DerrickRose_FT, DwayneWade_FT)
colnames(Player_FT) <- c(Seasons) 
rownames(Player_FT) <- c(Players) 
Player_FT #show Matrix

#Free Throw Attempts (vector)
...
Player_FTA <- rbind(KobeBryant_FTA, JoeJohnson_FTA, LeBronJames_FTA, CarmeloAnthony_FTA, DwightHoward_FTA, ChrisBosh_FTA, ChrisPaul_FTA,
                    KevinDurant_FTA, DerrickRose_FTA, DwayneWade_FTA)
colnames(Player_FTA) <- c(Seasons)
rownames(Player_FTA) <- c(Players)
Player_FTA #show Matrix
