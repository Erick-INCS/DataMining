...
#Matrix
ft.mat <- matrix(c(KobeBryant_FT, JoeJohnson_FT, LeBronJames_FT,
...
#Matrix
fta.mat <- matrix(c(KobeBryant_FTA, JoeJohnson_FTA, LeBronJames_FTA,
         CarmeloAnthony_FTA, DwightHoward_FTA, ChrisBosh_FTA,
         ChrisPaul_FTA, KevinDurant_FTA, DerrickRose_FTA, DwayneWade_FT),
       ncol=10)
